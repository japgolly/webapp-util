package japgolly.webapputil.core.test

import japgolly.scalajs.react.{AsyncCallback, Callback, CallbackTo}
import japgolly.webapputil.core.ajax._
import japgolly.webapputil.core.general._
...
object TestAjaxClient {
  ...
  trait Module {
    ...
    final type TestAjaxClient                  = japgolly.webapputil.core.test.TestAjaxClient[Codec]
